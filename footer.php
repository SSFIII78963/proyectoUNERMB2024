<footer>
    ...
    <div class="informacion-contacto">
        ...
        <nav class="redes-sociales">
            <ul>
                <li>
                    <a href="https://www.youtube.com/@fondoeditorialunermb" target="_blank" rel="noopener">
