...
<body>
    ...
    $resultado = $conexion->query("SELECT * FROM eventos_cientificos WHERE eventos_cientificos_id = '$id' ")->fetch_assoc();
    ...
    <div id="titulocoleccion">
        <div id="mask2">
            ...
            <div class="descripcion">
                <h1 id="titulocol"><?= $resultado['titulo_evento'] ?></h1>
                <p id="descripcioncol"><?= $resultado['sinopsis_evento'] ?></p>
            </div>
        </div>
    </div>
    <div class="libro">
